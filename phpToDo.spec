...
phpToDo jest prostą listą rzeczy "ToDo" napisaną w PHP z backendem w
MySQL. Posiada bardzo prosty i efektywny sposób na śledzenie rzeczy do
zrobienia oraz sortowania zadań według priorytetów. Interfejs jest
zrobiony aby być jak najprostszym.
